      ...
      <div className="border-b border-[#1a1a1a] py-10 px-6">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <form className="flex gap-0 w-full max-w-sm">
            <input type="email" placeholder={t('footer.emailPlaceholder')} className="flex-1 bg-[#1a1a1a] border border-[#333] text-[#F0EDE8] font-mono text-xs px-4 py-3 outline-none focus:border-[#FF2200] transition-colors placeholder-[#F0EDE8]/20" />
            <button type="submit" className="bg-[#FF2200] text-[#080808] font-mono text-xs px-5 py-3 hover:bg-[#F0EDE8] transition-colors">→</button>
          </form>
        </div>
      </div>
      <div className="py-8 px-6">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/shipping" className="font-mono text-xs uppercase tracking-widest text-[#F0EDE8]/50 hover:text-[#FF2200] transition-colors">{t('nav.shipping')}</Link>
          </div>
